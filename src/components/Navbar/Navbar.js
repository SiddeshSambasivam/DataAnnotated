        ...
        <ul className="navbar-nav">
          <li className="logo">
            <a href="/home" className="nav-link">
              <span className="link-text logo-text header-text">Data Annotated</span>
            </a>
          </li>
    
          <li className="nav-item">
            <a href="/home" className="nav-link">
            <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="home" className="svg-inline--fa " role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
                <g>
      ...
      {/* <nav>
        ...
        <nav>
          <ul className="topbar">
            <li>
              <h2>
                Welcome {cachedData.user_data.name}!
              </h2>
            </li>
            <li>
              <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="user" class="svg-inline--fa fa-user fa-w-14" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
